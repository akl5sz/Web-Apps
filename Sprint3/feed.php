        ...
        <div class="card mb-3 mx-auto bordered" style="max-width: 540px;margin-top: 10px;">
          <div class="row g-0">
            <div class="col-md-4 d-flex align-items-center">
              <img src="https://upload.wikimedia.org/wikipedia/en/thumb/f/fa/The_Muppet_Show_%281977%29_soundtrack_album_cover.jpg/220px-The_Muppet_Show_%281977%29_soundtrack_album_cover.jpg" class="img-fluid rounded-start playlist-card" alt="The Muppet Show album cover featuring Kermit the Frog holding a microphone with the cast behind him.">
            </div>
            <div class="col-md-8">
              <div class="card-body">
